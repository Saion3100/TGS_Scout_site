...
<section class="detail-cta"><p>この作品について詳しく聞きたい</p><a class="button button-primary" href="<?= e(url('contact.php', ['team' => $team['id']])) ?>">学校へ問い合わせる <span>→</span></a></section>
<a class="detail-sticky-cta" href="<?= e(url('contact.php', ['team' => $team['id']])) ?>" aria-label="作品「<?= e($team['game_name']) ?>」について学校へ相談する">
