...
<section class="intro section-pad"><p class="section-number">CONTACT POLICY</p><div class="intro-grid"><h2>学生の連絡先は<br>公開していません。</h2><div><p>企業の皆さまと学生の双方が安心してやり取りできるよう、国際理工カレッジが連絡窓口となります。</p><a class="button button-primary" href="/contact.php">学校へ問い合わせる <span>→</span></a></div></div></section>
<?php renderFooter(); ?>
