...
<div class="admin-grid"><aside class="admin-list"><div class="admin-list-head"><strong>登録作品</strong><span><?=count($teams)?>件</span></div><a class="button button-primary <?= $isNew?'is-current':'' ?>" href="<?=e(url('teams_admin.php'))?>?new=1">＋ 新しい作品を追加</a><?php foreach($teams as $item):?><a class="<?= $selectedId===($item['id']??'')?'is-current':''?>" href="<?=e(url('teams_admin.php'))?>?id=<?=e($item['id'])?>"><span><strong><?=e($item['game_name'])?></strong><small><?=e($item['team_name'])?></small></span><span class="admin-status is-public">公開</span></a><?php endforeach;?></aside>
