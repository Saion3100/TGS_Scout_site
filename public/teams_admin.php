...
if ($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['save_team'])) {
    try {
        ...
        $required=['team_name'=>'チーム名','game_name'=>'作品名','genre'=>'ジャンル','players'=>'プレイ人数','engine'=>'使用エンジン','production_period'=>'制作期間','catchcopy'=>'キャッチコピー','description'=>'作品説明'];
