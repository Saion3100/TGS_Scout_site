...
<section class="profile-hero">
    ...
    <div class="profile-hero-grid">
        ...
        <div class="profile-title">
            ...
            <p class="profile-meta"><?= e($student['name_kana'] ?? '') ?>　/　<?= e($student['grade'] ?? '') ?>　/　<?= e($student['graduation_year'] ?? '') ?><br><?= e($student['course'] ?? '') ?></p>
...
<section class="profile-facts section-pad">
    ...
    <div class="facts-grid">
        <div><span>希望職種</span><strong><?= e(implode(' / ', $student['desired_roles'] ?? [$student['role_ja']])) ?></strong></div>
...
<section class="responsibilities section-pad">
    <p class="section-number">03 — RESPONSIBILITIES</p>
...
<section class="portfolio section-pad">
    <p class="section-number">05 — PORTFOLIO</p>
    <div class="section-head"><h2>ポートフォリオ</h2>
    <div class="resource-actions">
    <?php if (!empty($student['vivivit_url'])): ?><a class="button button-primary" href="<?= e($student['vivivit_url']) ?>" target="_blank" rel="noopener">VIVIVITで作品を見る <span>↗</span></a>
    <?php elseif (!empty($student['portfolio_url'])): ?><a class="button button-primary" href="<?= e($student['portfolio_url']) ?>" target="_blank" rel="noopener">資料を別画面で見る <span>↗</span></a><?php endif; ?>
    ...
    <?php if (!empty($student['planner_document_url'])): ?><a class="button button-outline" href="<?= e($student['planner_document_url']) ?>" target="_blank" rel="noopener">企画書を見る <span>↗</span></a><?php endif; ?>
    </div>
    </div>
