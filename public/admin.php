...
if ($section === 'featured') {
    ...
    <section class="admin-shell">
      ...
      <nav class="admin-tabs" aria-label="管理データ"><a href="<?= e(url('admin.php')) ?>">学生</a><a class="is-active" aria-current="page" href="<?= e(url('admin.php')) ?>?section=featured">注目学生</a><a href="<?= e(url('teams_admin.php')) ?>">作品</a></nav>
